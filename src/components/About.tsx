...
const About = () => {
    ...
    return (
        <motion.div
            ...
            className=" text-white p-10 h-[500px] flex flex-col mt-[100px] items-center justify-between bg-cover z-1">
            <div className="w-full p-10 text-center flex items-center justify-center">
                <h2 className="font-bold text-4xl text-black">About <span className="text-[#48281A] relative inline-block">
                    Us
            ...
            <div className="w-full p-10 flex items-center justify-between">
                <div className="w-1/2 flex items-center justify-center">
                    <img src={people} alt="Image" className="rounded-md w-[400px] h-[400px] object-cover transform rotate-45 hover:transform hover:rotate-[-45] hover:transition-all hover:ease-in-out cursor-pointer" />
                </div>
                <div className="w-1/2 text-gray-800 p-10 rounded-lg flex items-center justify-between">
                    <p className="">
                        ...
                        <button className="px-8 py-3 bg-[#AB6832] text-white rounded-full hover:bg-[#6C4625]  transition duration-300 ease-in-out font-semibold">Explore more</button>
                    </p>
                </div>
